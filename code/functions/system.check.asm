...
system.check.populate.connection.numbers.1000:  mov     byte [ebx], char.0                                          ; Zero the byte at [ebx].
                                                ...
                                                cmp     byte [ebx], char.9                                          ; Is the byte at [ebx] a "9"?
                                                jz      system.check.populate.connection.numbers.over               ; Yes. At this point, we're experiencing a bounds error, so go tell the admin we're
                                                                                                                    ; fucked and shut down the server.

...
;------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    build.pouch:                        push  esi                                                                          ; Preserve index to socket entry.
                                        ...
                                        mov   ebx, eax                                                                     ; Yes. Let's close it up so we can search the next id up the ladder. ebx - descriptor to be disassociated.
...
;------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    area.filename.out.of.ids:           pop   esi                                                                          ; esi - Index to socket entry.
                                        ...
                                        mov   dword [socket.data.send.buffer.pointer], socket.data.out.of.area.ids.message ; Point send function to message indicating that we're fresh out of area ids.
                                        ...
                                        mov   ecx, local.data.out.of.area.ids.message                                      ; ecx - Pointer to local message indicating that we're fresh out of area ids.

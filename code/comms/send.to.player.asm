...
send.to.player.connection.poll:     cmp     dword [esi+connection.descriptor.index], ebx    ; Does the area id associated with this connection match the area id to be broadcast?
